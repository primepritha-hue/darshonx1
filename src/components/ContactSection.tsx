    ...
    <section id="contact" className="relative py-32">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <ScrollReveal direction="left" blur delay={0.15}>
            <div className="space-y-6">
              ...
              {[
                ...
                <ScrollReveal key={i} delay={0.3 + i * 0.1} direction="left">
                  <AuraGlow glowColor={glow} className="flex items-center gap-4 rounded-lg p-3 cursor-default">
          ...
          <ScrollReveal direction="right" scale blur delay={0.2}>
